  ...
  <nav class="navbar navbar-expand-lg navbar-light navcolor sticky-top">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav flex-row main-nav-icons d-none d-lg-flex me-auto">
        <li class="nav-item">
          <a class="nav-link" href="aluno" title="Página Inicial"><i class="fas fa-home"></i></a>
        </li>
        <li class="nav-item">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          ...
          <ul class="navbar-nav collapse-nav-links justify-content-end flex-grow-1 pe-3">
            <li class="nav-item">
              <a class="nav-link" href="../outros/livros.php" title="Livros"><i class="fas fa-book-open"></i>Livros</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../perfil/perfil_aluno.php" title="Perfil"><i class="fas fa-user-circle"></i>Perfil</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href=../outros/livros.php" title="Boletim"><i class="fas fa-clipboard-list"></i>Boletim</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" title="Mensagens"><i class="fas fa-comment-dots"></i>Mensagens</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../chat/assistente.php" title="Assistente"> <i class="fas fa-robot"></i>Assistente</a>
            </li>
          </ul>
        </div>
      </div>
